...
def process_single_task(task):
    ...
    try:
        ...
        voxelize_distance(smpl_mesh, res, out_occ, out_scal, id_)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "/home/boqian/code/NICP/datafolder/CAPE_reorganized/cape_release/smpl_reorganized/"
        ),
    ...
    parser.add_argument(
        ...
        "-o",
        type=Path,
        default=Path("/home/boqian/code/NICP/training/processed_data/CAPE/"),
