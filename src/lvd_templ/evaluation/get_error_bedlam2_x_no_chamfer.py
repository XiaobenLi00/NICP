...
def main():
    ...
    gt_smpl_folder = "datafolder_new/BEDLAM2/selected_data"
    gt_scan_folder = "datafolder_new/BEDLAM2/selected_data"
    # pred_folder = (
    ...
    # pred_folder = "output/matchAMASS/bedlam2_pred_inner_points_x_cloth3d_50k_amass_30k_epoch_99"
    # pred_folder = "output/matchAMASS_4D-DRESS/bedlam2_pred_inner_points_x_4d-dress_epoch_79"
    pred_folder = 'output/matchAMASS_4D-DRESS/bedlam2_hitpts_x_4d-dress_epoch_79'
    ...
    for name in tqdm(os.listdir(os.path.join(pred_folder, "vis"))):
        ...
        gt_smpl_path = os.path.join(gt_smpl_folder, name, f"smplx_mesh.obj")
        # gt_scan_path = os.path.join(gt_scan_folder, name, f"{name}.obj")
        gt_scan_path = os.path.join(gt_scan_folder, name, f"scan.obj")
