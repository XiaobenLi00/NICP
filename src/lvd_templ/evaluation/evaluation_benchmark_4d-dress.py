...
def run(cfg: DictConfig) -> str:
    ...
    # out_dir = out_folder + model_name + '/' + '4d-dress_hitpts'
    # out_dir = out_folder + model_name + '/' + '4d-dress_pred_inner_points'
    # out_dir = out_folder + model_name + '/' + '4d-dress_eq_hitpts'
    out_dir = out_folder + model_name + '/' + '4d-dress_eq_pred_inner_points'
    ...
    path_in = '/home/lixiaoben/projects/NICP/datafolder/4D-DRESS/4d-dress_eq_epoch_20_test'
